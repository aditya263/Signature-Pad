    ...
    public void storeImage(ModelClass objectModelClass){
        try {
            ...
            if (checkIfQueryRuns!= -1){
                ...
                Toast.makeText(context, "Data added in our table", Toast.LENGTH_SHORT).show();
        ...
        try {
            ...
            if (objectCursor.getCount()!=0){
                ...
                while (objectCursor.moveToNext()){
                    ...
                    byte[] objectByte = objectCursor.getBlob(1);

                    Bitmap objectBitmap = BitmapFactory.decodeByteArray(objectByte,0,objectByte.length);
